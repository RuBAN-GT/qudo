    ...
    module DependenceResolver
      class << self
        ...
        def resolve(dependencies, requirements = [])
          ...
          retrieved.each_with_object(retrieved) { |(k, v), total| total[k] = resolve_dependence v }
        end
        ...
        private
          ...
          def resolve_dependence(dependence)
            return dependence.resolve if dependence.respond_to? :resolve
